...
import sweetie.evaware.api.render.font.FontData.AtlasData;
import sweetie.evaware.api.render.font.FontData.MetricsData;
import sweetie.evaware.helpers.ReplaceUtil;
import sweetie.evaware.helpers.TextUtil;

import java.awt.*;
import java.util.List;
import java.util.Map;

import static sweetie.evaware.api.render.Renderable.SHADER_CORE_PATH;
